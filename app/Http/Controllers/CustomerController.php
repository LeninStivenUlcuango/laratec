...
class CustomerController extends Controller
{
    ...
    {
        //
        $customers = Customer::customerFilter($request->client_data);
    ...
    public function store(CreateRequest $request)
    {
        ...
        $request->session()->flash('message','Cliente ingresado correctamente');
    ...
    public function destroy(Request $request, $id)
    {
        if($request->ajax()){
            ...
            return response()->json([
                'error'=>false, 
                'message'=>'Cliente eliminado correctamente '.$id
            ],status: 200);
        } 
    }
}
